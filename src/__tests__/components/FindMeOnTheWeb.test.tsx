...
import FindMeOnTheWeb from '../../components/FindMeOnTheWeb';

describe('<FindMeOnTheWeb />', () => {
  const props = {
    key: 'FindMeOnTheWeb',
  ...
  beforeEach(() => {
    render(<FindMeOnTheWeb {...props} />);
  });

  it('Should render the section title', () => {
    expect(screen.getByRole('heading', { level: 4, name: props.title }));
  });
});
